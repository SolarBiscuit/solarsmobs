...
public class FemboyScreen extends AbstractContainerScreen<FemboyMenu> {
    private static final ResourceLocation SMALL_TEXTURE = new ResourceLocation(WildFemboys.MOD_ID, "textures/gui/femboy_inventory_small.png");
    private static final ResourceLocation LARGE_TEXTURE = new ResourceLocation(WildFemboys.MOD_ID, "textures/gui/femboy_inventory_large.png");
